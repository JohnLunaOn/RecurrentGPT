...
def init_prompt(novel_type, description):
    ...
    return f"""
Please write a {novel_type} novel {description} with 50 chapters. 
The name of Novel is: "{novel_name}".
...
Write an outline based on the provided background and beginning for the first chapter.
Write the next three paragraphs with their indication of the novel based on the provided beginning and your outline. Write in a novelistic style and take your time to set the scene.
